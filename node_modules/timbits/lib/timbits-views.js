(function() {
                ...
                _results.push(tr(function() {
                  ...
                  if (attr.values) {
                    return td(function() {
                      ...
                      return ul(function() {
                        var value, _i, _len, _ref2, _results2;
                        _ref2 = attr.values;
                        _results2 = [];
                        for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
                          value = _ref2[_i];
                          _results2.push(li(value));
                        }
                        return _results2;
                      });
                    });
  ...
  exports.timbit_test = function() {
    ...
    return div({
      ...
      var failed, passed, test, _i, _len, _ref, _ref2, _ref3;
      h1({
        "class": 'test_title'
      }, function() {
      ...
      if (((_ref = this.required) != null ? _ref.length : void 0) > 0) {
        div({
          ...
          return ul(function() {
            var required, _i, _len, _ref2, _results;
            _ref2 = this.required;
            _results = [];
            for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
              required = _ref2[_i];
      ...
      if (((_ref2 = this.optional) != null ? _ref2.length : void 0) > 0) {
        div({
          ...
          return ul(function() {
            var optional, _i, _len, _ref3, _results;
            _ref3 = this.optional;
            _results = [];
      ...
      if (passed > 0) {
        div({
          ...
          return table(function() {
            ...
            return tbody(function() {
              var test, _j, _len2, _ref4, _results;
              _ref4 = this.tests;
              _results = [];
              for (_j = 0, _len2 = _ref4.length; _j < _len2; _j++) {
                test = _ref4[_j];
                _results.push(test.status === 200 ? tr(function() {
                  td(test.type);
                  return td(function() {
                    return a({
                      href: test.uri,
      ...
      if (this.warnings.length > 0) {
        return div({
          ...
          return table(function() {
            ...
            return tbody(function() {
              var warning, _j, _len2, _ref4, _results;
              _ref4 = this.warnings;
              _results = [];
              for (_j = 0, _len2 = _ref4.length; _j < _len2; _j++) {
                warning = _ref4[_j];
